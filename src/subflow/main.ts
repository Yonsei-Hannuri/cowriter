...
export const Introduce = introduce({
  ...
  curtainClassName:
    'position-absolute rounded top-0 w-100 h-100 bg-secondary opacity-75',
  tooltipClassName:
    'font-weight-normal w-100 h-100 position-absolute top-0 left-0 bottom-0 right-0 m-auto text-center text-wrap',
});
